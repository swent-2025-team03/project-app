...
/**
 * UI tests for [OverviewScreen]. This test class verifies the presence of stable UI elements in the Overview screen.
 * It DOES NOT check the presence of dynamic data such as report items.
 */
