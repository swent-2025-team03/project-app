...
/**
 * UI tests for [OverviewScreen]. These tests verify that key elements are displayed correctly
 * and behave as expected for different user roles.
 */
