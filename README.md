...
- **Office Management** for vets to work efficiently within a same office
...
- **Push notifications** for farmers and vets when farmer create a new report, or vets respond to it 
...
- Authorities post a region-wide alert about a local outbreak of a contagious animal disease. Farmers receive the official news, see how close they are to the affected region, while vets can prepare for preventive visits.  

---

## Further Improvements
- **Analytics tools** for veterinarians to monitor symptom trends across farms
- **Connection to the existing ecosystem** by making the App compatible with existing platform like SenseHub
- **Custom Report Question** accross offices

---

## More 
If you are looking for more informations about our App, please go take a look at our [Wiki](https://github.com/swent-2025-team03/project-app/wiki)
