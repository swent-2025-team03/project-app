...
You qualified for a Blue Belt 🥋🔵 and got a final grade of 5.43/6 for M1. Excellent work! You're demonstrating advanced skills. 
...
|---------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, CI, tests)** | 4.58 out of 6 | 40%        | [See Details](#implementation-apk-ci-tests) |
...
The APK is functional, we didn't find any major bug or crash. The functionality is quite minimal for now, it lacks google authentication and reactivity when going into landscape mode.
- Sonar is correctly integrated in the repo
- The tests are run by the CI
- There is at least one meaningful end-to-end test
- The line coverage on M1 code is 75
...
For this part, you received 4.58 points out of a maximum of 6.
...
Your team grade for milestone M1 is 5.43. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
